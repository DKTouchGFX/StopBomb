 ...
 */
__weak void waitUntilTransmitEnd()
{
    /* NOTE: This function should not be modified, when the fuction is needed,
     *       waitUntilTransmitEnd should be implemented in the user file
     */
}

/**
 * Wait until display is ready to receive a Frame Buffer Block ending.
 */
__weak void waitUntilCanTransferBlock(uint16_t bottom)
{
    /* NOTE: This function should not be modified, when the fuction is needed,
     *       waitUntilCanTransferBlock should be implemented in the user file
     */
}
